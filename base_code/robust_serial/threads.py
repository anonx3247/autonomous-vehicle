...
class CommandThread(threading.Thread):
    """
    Thread that sends orders to the Arduino.
    It blocks if there are no more send_tokens left (here it is the n_received_semaphore).
...
class ListenerThread(threading.Thread):
    """
    Thread that listens to the Arduino.
